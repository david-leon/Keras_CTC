...
def _preprocess_border_mode(border_mode):
    """
    [DV] change the border_mode conversion logic, support 'same' mode exactly
    :param border_mode:
    :return:
    """
    if border_mode == 'half':
...
def _postprocess_conv2d_output(conv_out, x, border_mode, np_kernel, strides, dim_ordering):
    """
    [DV] change the 'border_mode' postprocess logic, support for 'same' mode exactly
    :param conv_out:
    :param x:
    :param border_mode:
    :param np_kernel:
